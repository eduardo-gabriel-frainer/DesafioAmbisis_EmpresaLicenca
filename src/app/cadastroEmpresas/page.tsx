...
export default function Empresas() {
    ...
    if (loading) return <p className="text-center text-gray-700">Carregando dados...</p>;

    return (
        <div className="flex flex-col items-center min-h-screen bg-gray-100 p-10">
            <h1 className="text-4xl font-bold text-gray-800 mb-6 mt-18">
                {id ? 'Editar Empresa' : 'Cadastro de Empresas'}
            </h1>
